...
0009    J Reucker   15/04/10 Issue #292 Fixed problems with ATmega8 (thanks to
Pete62) 0010    jipp        15/04/13 added additional define check #2923 0011
MCUdude     08/01/18 Fix problems with tone on ATmega64/128 (thanks to wolfbert)
*************************************************/
...
#    define TIMSK1            TIMSK
#elif defined(__AVR_AT90CAN32__) || defined(__AVR_AT90CAN64__) || \
...
static uint8_t        tone_pins[AVAILABLE_TONE_PINS] = {255 /*, 255 */};
    ...
    defined(__AVR_ATmega645P__) || defined(__AVR_ATmega6450__) ||    \
    ...
    defined(__AVR_ATmega649P__) || defined(__AVR_ATmega6490__) ||    \
...
void tone(uint8_t _pin, unsigned int frequency, unsigned long duration) {
    ...
    if (_timer >= 0) {
        ...
        // if we are using an 8 bit timer, scan through prescalars to find the
        // best fit
        if (_timer == 0 || _timer == 2) {
            ...
            if (ocr > 255) {
                ...
                if (ocr > 255) {
                    ...
                    prescalarbits = _timer != TIMER_WITH_FULL_PRESCALER ? 0x03
                                                                        : 0x04;
                    ...
                    if (ocr > 255) {
                        ...
                        prescalarbits =
                            _timer != TIMER_WITH_FULL_PRESCALER ? 0x04 : 0x06;
                        if (ocr > 255) {
                            // Can't do any better than /1024
                            ocr           = F_CPU / frequency / 2 / 1024 - 1;
                            prescalarbits = _timer != TIMER_WITH_FULL_PRESCALER
                                                ? 0x05
                                                : 0x07;
                        }
                    }
...
#    endif
{
    ...
    if (timer2_toggle_count != 0) {
        ...
        *timer2_pin_port ^= timer2_pin_mask;
        ...
        noTone(tone_pins[0]);
        //    disableTimer(2);
        //    *timer2_pin_port &= ~(timer2_pin_mask);  // keep pin low after
        //    stop
    }
}
#endif
